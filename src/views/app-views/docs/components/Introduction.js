	...
	return (
		<div>
			...
			<p className="font-size-md">
				<strong>SK Strategic Soft</strong> - 
				...
				SK Strategic Soft can be used to build any modern web application including a SaaS, admin panels, CRM, CMS, e-commerce panel, etc.
			</p>
			<p className="font-size-md">
				<strong>NOTE: </strong>
				<span>
