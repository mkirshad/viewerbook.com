...
const jwt = () => {
	return (
		<div>
			<h2>JWT</h2>
			<p>SK Strategic Soft provide a set of code to let you work with JWT authentication & API with the server application, integration process is described below.</p>
			<div className="mt-4">
